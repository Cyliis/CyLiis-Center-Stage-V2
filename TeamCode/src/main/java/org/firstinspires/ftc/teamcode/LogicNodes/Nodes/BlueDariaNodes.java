...
public class BlueDariaNodes {
    ...
    public static double outtakeActivationLine = 45;
    ...
    private void initPositions(int detectionCase){
        switch (detectionCase){
            case 1:
                ...
                scoreWhitePosition = BlueDariaPositions.scoreWhitePosition1;
            ...
            case 2:
                ...
                scoreWhitePosition = BlueDariaPositions.scoreWhitePosition2;
            ...
            case 3:
                ...
                scoreWhitePosition = BlueDariaPositions.scoreWhitePosition3;
