...
public class MecanumDrive implements IRobotModule {
    ...
    public MecanumDrive(Hardware hardware, RunMode runMode, boolean brake){
        ...
        frontLeft = new CoolMotor(hardware.mch3, CoolMotor.RunMode.RUN, frontLeftMotorReversed);
        ...
        backRight = new CoolMotor(hardware.mch1, CoolMotor.RunMode.RUN, backRightMotorReversed);
