...
public class CubicBezierTangentHeadingTrajectorySegment extends TrajectorySegment {
    ...
    public CubicBezierTangentHeadingTrajectorySegment(Pose startPoint, Pose controlPoint0, Pose controlPoint1, Pose endPoint, double tangentHeadingOffset){
        this.startPoint = startPoint;
        this.controlPoint0 = controlPoint0;
        this.controlPoint1 = controlPoint1;
        this.endPoint = endPoint;
        this.tangentHeadingOffset = tangentHeadingOffset;
        init();
    }

    public CubicBezierTangentHeadingTrajectorySegment(CubicBezierTangentHeadingTrajectorySegment previousCurve, Pose controlPoint1, Pose endPoint, double tangentHeadingOffset){
    ...
    public CubicBezierTangentHeadingTrajectorySegment(Pose startPoint, Pose controlPoint0, Pose controlPoint1, Pose endPoint){
        this(startPoint, controlPoint0, controlPoint1, endPoint, 0);
    }
    ...
    public CubicBezierTangentHeadingTrajectorySegment(CubicBezierTangentHeadingTrajectorySegment previousCurve, Pose controlPoint1, Pose endPoint){
        this(previousCurve, controlPoint1, endPoint, 0);
        init();
    }
    ...
    public Pose getPose(double t) {
        if(t==1) return new Pose(endPoint.getX(), endPoint.getY(), endPoint.getHeading() + tangentHeadingOffset);
    ...
    public double getHeading(double t) {
        return getPose(t).getHeading() + tangentHeadingOffset;
    }
