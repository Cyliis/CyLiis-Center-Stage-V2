...
public class RedPositions {
    ...
    public static int preloadIntakeExtendoPosition3 = 750;
    ...
    public static Pose[] intakePositions3 = {
            new Pose(50,-12.5,-Math.PI/2),
            new Pose(51.5,-12.5,-Math.PI/2),
            new Pose(54,-12,-1.3),
            new Pose(0,0,0)
    };
    ...
    public static Pose scoreWhitePosition2 = new Pose(21,-90,-Math.PI/2);
    public static Pose scoreYellowPosition2 = new Pose(30,-90,-Math.PI/2);
    ...
    public static Pose scoreWhitePosition1 = new Pose(28,-90.5,-Math.PI/2);
    public static Pose scoreYellowPosition1 = new Pose(35,-90.5,-Math.PI/2);

    public static Pose alignToCrossBackPosition1 = new Pose(52,-75,-Math.PI/2);
    public static Pose[] intakePositions1 = {
            new Pose(52.5,-13,-Math.PI/2),
            new Pose(54,-13,-Math.PI/2),
            new Pose(54,-13,-1.3),
            new Pose(0,0,0)
    };
